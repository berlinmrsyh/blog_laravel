                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="seotitle" id="seotitle" value="{{ old('seotitle') }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="meta_description">Meta Description (SEO)</label>
                            <textarea class="form-control" name="meta_description" id="meta_description" value="{{ old('description') }}" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="form-group">
                        ...
                        <div class="col">
                            <div class="col-3">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="radio" name="is_publish" id="is_publish_yes" value="Publish" @if ($posts->is_published == 1) checked @endif>
                                        <label for="is_publish_yes">Yes</label>

                                        <input type="radio" name="is_publish" id="is_publish_no" value="Draft" @if ($posts->is_published == 0) checked @endif>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="radio" name="active" id="active_yes" value="Yes" @if ($posts->activeed == 1) checked @endif>
                                    <label for="active_yes">Yes</label>

                                    <input type="radio" name="active" id="active_no" value="No" @if ($posts->activeed == 0) checked @endif>
...
<!-- datepicker -->
<link rel="stylesheet" href="{{ asset('assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker3.min.css') }}">
