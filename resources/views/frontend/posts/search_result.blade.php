                    ...
                    <div class="col">
                        <div class="card border-0 bg-light-subtle rounded-3 shadow">
                            <a href="{{ route('posts.show', ['slug' => $searchResult->slug]) }}">
                                ...
                                <img src="{{ asset('storage/images/posts/' . $searchResult->image) }}" class="card-img-top">
                                @else
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="{{ route('posts.show', ['slug' => $searchResult->slug]) }}" class="text-decoration-none">
                            ...
                            <div class="card-footer border-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-end">
                                        <a href="{{ route('posts.show', ['slug' => $searchResult->slug]) }}" class="btn btn-sm btn-primary">Read more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
