                ...
                <div class="row row-cols-1 row-cols-md-2 g-4 mb-3" data-masonry='{"percentPosition": true }'>
                    ...
                    <div class="col">
                        <div class="card border-0 bg-light-subtle rounded-3 shadow">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="{{ route('posts.show', ['slug' => $latestPost->slug]) }}" class="text-decoration-none">
                            ...
                            <div class="card-footer border-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-end">
                                        <a href="{{ route('posts.show', ['slug' => $latestPost->slug]) }}" class="btn btn-sm btn-primary">Read more</a>
                                    </div>
                                </div>
                            </div>
                        </div>
